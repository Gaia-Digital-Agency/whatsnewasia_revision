...
const Radio = ({
  ...
  return /* @__PURE__ */ jsxs(
    ...
    {
      htmlFor: id,
      className: `relative flex cursor-pointer  select-none items-center gap-3 text-base font-medium ${disabled ? "text-gray-300 dark:text-gray-600 cursor-not-allowed" : "text-gray-700 dark:text-gray-400"} ${className}`,
      children: [
        /* @__PURE__ */ jsx(
          "input",
          {
