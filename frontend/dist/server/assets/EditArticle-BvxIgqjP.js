...
import React__default, { createRef, useState, useRef, useEffect } from "react";
import { useOutletContext, useParams, useNavigate, Link as Link$1 } from "react-router";
import { e as getArticleByKeyword, a as getArticleByFields, f as getArticleById, h as editArticleById, i as createArticle } from "./article.service-ByHKHK-J.js";
import { u as useNavigationPrompt } from "./useNavigationPrompt-DiFBqK8C.js";
import { u as useModal } from "./useModal-C9BZm3Uo.js";
import { I as Input$1 } from "./InputField-CcQ93cDN.js";
import { M as Media, A as AdminFeaturedImage } from "./FeaturedImage-D9IQ7WGP.js";
import { isEqual, cloneDeep, merge } from "lodash-es";
import * as Parchment from "parchment";
import { EmbedBlot, TextBlot, InlineBlot, Scope, AttributorStore, BlockBlot, LeafBlot, ParentBlot, Registry, ContainerBlot, ScrollBlot, Attributor, ClassAttributor, StyleAttributor } from "parchment";
import Delta, { Op, AttributeMap } from "quill-delta";
...
import { g as getAllTags } from "./tags.service-CuSMBS4C.js";
import ReactSelect from "react-select";
import { b as useTaxonomies, u as useAuth } from "./TimeContext-CSdMZCoU.js";
...
import "./media.service-CRrX0g_t.js";
import "./MediaForm-B0jtcB6B.js";
...
import "lucide-react";
import "slugify";
const SvgInfo = (props) => /* @__PURE__ */ React.createElement("svg", { className: "size-5", xmlns: "http://www.w3.org/2000/svg", width: "1em", height: "1em", viewBox: "0 0 24 24", fill: "none", ...props }, /* @__PURE__ */ React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M3.6501 11.9996C3.6501 7.38803 7.38852 3.64961 12.0001 3.64961C16.6117 3.64961 20.3501 7.38803 20.3501 11.9996C20.3501 16.6112 16.6117 20.3496 12.0001 20.3496C7.38852 20.3496 3.6501 16.6112 3.6501 11.9996ZM12.0001 1.84961C6.39441 1.84961 1.8501 6.39392 1.8501 11.9996C1.8501 17.6053 6.39441 22.1496 12.0001 22.1496C17.6058 22.1496 22.1501 17.6053 22.1501 11.9996C22.1501 6.39392 17.6058 1.84961 12.0001 1.84961ZM10.9992 7.52468C10.9992 8.07697 11.4469 8.52468 11.9992 8.52468H12.0002C12.5525 8.52468 13.0002 8.07697 13.0002 7.52468C13.0002 6.9724 12.5525 6.52468 12.0002 6.52468H11.9992C11.4469 6.52468 10.9992 6.9724 10.9992 7.52468ZM12.0002 17.371C11.586 17.371 11.2502 17.0352 11.2502 16.621V10.9445C11.2502 10.5303 11.586 10.1945 12.0002 10.1945C12.4144 10.1945 12.7502 10.5303 12.7502 10.9445V16.621C12.7502 17.0352 12.4144 17.371 12.0002 17.371Z", fill: "#0BA5EC" }));
...
Break.tagName = "BR";
let Text$1 = class Text2 extends TextBlot {
};
const entityMap = {
  "&": "&amp;",
  "<": "&lt;",
...
const _Inline = class _Inline extends InlineBlot {
...
__publicField(_Inline, "allowedChildren", [_Inline, Break, EmbedBlot, Text$1]);
...
Block.allowedChildren = [Break, Inline, EmbedBlot, Text$1];
...
const _Cursor = class _Cursor extends EmbedBlot {
...
class Editor {
    ...
    normalizedOps.reduce((index, op) => {
      ...
      if (op.insert != null) {
        ...
        if (typeof op.insert === "string") {
          ...
          let formats2 = merge({}, bubbleFormats(line));
          if (line instanceof Block) {
            const [leaf] = line.descendant(LeafBlot, offset);
            if (leaf) {
              formats2 = merge(formats2, bubbleFormats(leaf));
            }
          }
          attributes = AttributeMap.diff(formats2, attributes) || {};
          ...
          if (isInlineEmbed) {
            ...
            if (leaf) {
              const formats2 = merge({}, bubbleFormats(leaf));
              attributes = AttributeMap.diff(formats2, attributes) || {};
            }
          }
        }
  ...
  formatLine(index, length) {
    ...
    this.scroll.optimize();
    const delta = new Delta().retain(index).retain(length, cloneDeep(formats2));
  ...
  insertText(index, text) {
    ...
    return this.update(new Delta().retain(index).insert(text, cloneDeep(formats2)));
  }
  isBlank() {
...
const createRegistryWithFormats = (formats2, sourceRegistry, debug2) => {
...
function expandConfig(containerOrSelector, options) {
  ...
  const modules2 = merge({}, expandModuleConfig(quillModuleDefaults), expandModuleConfig(themeModuleDefaults), userModuleOptions);
  const config2 = {
    ...quillDefaults,
...
class Scroll extends ScrollBlot {
  ...
  insertContents(index, delta) {
    ...
    if (first) {
      ...
      const attributes = AttributeMap.diff(formats2, first.attributes) || {};
      Object.keys(attributes).forEach((name) => {
  ...
  inlineContents.reduce((index2, op) => {
    ...
    if (op.insert != null) {
      if (typeof op.insert === "string") {
        ...
        const [leaf] = parent.descendant(LeafBlot, index2);
...
const AlignClass = new ClassAttributor("align", "ql-align", config$2);
const AlignStyle = new StyleAttributor("align", "text-align", config$2);
...
const DirectionClass = new ClassAttributor("direction", "ql-direction", config$1);
const DirectionStyle = new StyleAttributor("direction", "direction", config$1);
const config = {
  scope: Scope.INLINE,
    ...
    if (context.offset === 0) {
      ...
      if (prev) {
        ...
        if (!isPrevLineEmpty) {
          ...
          formats2 = AttributeMap.diff(curFormats, prevFormats) || {};
          if (Object.keys(formats2).length > 0) {
            const formatDelta = new Delta().retain(range.index + line.length() - 2).retain(1, formats2);
  ...
  handleDelete(range, context) {
    ...
    if (context.offset >= line.length() - 1) {
      ...
      if (next) {
        ...
        formats2 = AttributeMap.diff(curFormats, nextFormats) || {};
        if (Object.keys(formats2).length > 0) {
...
function deleteRange(_ref2) {
  ...
  if (lines.length > 1) {
    ...
    formats2 = AttributeMap.diff(lastFormats, firstFormats) || {};
  }
...
class Clipboard extends Module {
  ...
  convert(_ref2) {
    ...
    if (!html) {
      return new Delta().insert(text || "", formats2);
    }
...
class Input extends Module {
  ...
  replaceText(range) {
    ...
    if (text) {
      ...
      this.quill.updateContents(new Delta().retain(range.index).insert(text, formats2), Quill.sources.USER);
    } else {
      this.deleteRange(range);
    }
...
class Image extends EmbedBlot {
  ...
  static formats(domNode) {
    return ATTRIBUTES$1.reduce((formats2, attribute) => {
  ...
  */
  renderEditingArea() {
    ...
    if (React__default.Children.count(children)) {
      return React__default.cloneElement(React__default.Children.only(children), properties);
    }
    return preserveWhitespace ? React__default.createElement("pre", { ...properties }) : React__default.createElement("div", { ...properties });
  }
  render() {
    return React__default.createElement("div", { ref: this.containerRef, id: this.props.id, style: this.props.style, key: this.state.generation, className: `quill ${this.props.className ?? ""}`, onKeyPress: this.props.onKeyPress, onKeyDown: this.props.onKeyDown, onKeyUp: this.props.onKeyUp }, this.renderEditingArea());
  }
...
const Advertisement = () => {
  return /* @__PURE__ */ jsx("div", { style: {
    ...
    margin: "1em 0",
    userSelect: "none"
    // Prevent user from selecting text inside
  }, children: /* @__PURE__ */ jsx("p", { style: { margin: 0, fontWeight: "bold", color: "#007bff" }, children: "🖼️ Advertisement Placeholder" }) });
};
const ArticleSearch = ({ onSave }) => {
  ...
  const loadOptions = async (inputValue) => {
    try {
      ...
      if (inputValue && inputValue.length > 3) {
        ...
        if (result == null ? void 0 : result.articles) articles = result.articles;
      } else {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "w-max-1/2", children: [
    /* @__PURE__ */ jsx(
      AsyncSelect,
      {
        onChange: (options) => {
    ...
    /* @__PURE__ */ jsx(Button, { onClick: () => onSave(selectedArticles), children: "Embed Article" })
  ] });
};
...
__publicField(HighlightBlot, "blotName", "highlight");
__publicField(HighlightBlot, "tagName", "div");
__publicField(HighlightBlot, "className", "quill-highlight");
...
__publicField(DropCapBlot, "blotName", "drop-cap");
__publicField(DropCapBlot, "tagName", "big");
__publicField(DropCapBlot, "className", "quill-drop-cap");
...
__publicField(AdBlot, "blotName", "advertisement");
__publicField(AdBlot, "tagName", "div");
__publicField(AdBlot, "className", "quill-ad-embed");
...
class CustomImage extends Block {
  ...
  static create(value) {
    ...
    caption.innerText = (value == null ? void 0 : value.caption) || "caption here";
  ...
  static value(_domNode) {
    var _a, _b;
    return {
      url: ((_a = _domNode.querySelector("img")) == null ? void 0 : _a.getAttribute("src")) || "",
      caption: ((_b = _domNode.querySelector("figcaption")) == null ? void 0 : _b.innerText) || ""
    };
  }
}
__publicField(CustomImage, "blotName", "custom-image");
__publicField(CustomImage, "tagName", "figure");
class FigureBlot extends BlockEmbed {
  ...
  static value(node) {
    var _a;
    return {
      src: (_a = node.querySelector("img")) == null ? void 0 : _a.src
      // caption: node.querySelector("figcaption")?.innerText || ""
    };
  }
}
__publicField(FigureBlot, "blotName", "figure");
__publicField(FigureBlot, "tagName", "figure");
const registerAllCustomFormats = (Quill2) => {
  Quill2.register(FigureBlot);
  if (Quill2.imports["blots/highlight"]) {
    return;
  }
  Quill2.register(CustomImage);
  Quill2.register(HighlightBlot);
  Quill2.register(DropCapBlot);
  Quill2.register(AdBlot);
  Quill2.register(CustomLink);
  Quill2.register(SizeClass, true);
  Quill2.register(FontClass, true);
  Quill2.register(AlignClass, true);
};
...
const CustomToolbar = () => {
  ...
  const onSave = (file) => {
    ...
    if (quillRef) {
      ...
      quillRef.insertEmbed(range.index, "image", `${API_URL$1}/${TempFile.path}`);
      quillRef.setSelection(range.index + 1, 0);
    }
  };
  const onArticle = (articles) => {
...
`;
        const imageUrl = `${API_URL$1}/${article.featured_image_url}`;
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Modal, { isOpen, onClose: closeModal, children: /* @__PURE__ */ jsx(Media, { onSave: (file) => {
      onSave(file);
    } }) }),
    /* @__PURE__ */ jsx(Modal, { isOpen: articleModal, isFullscreen: false, onClose: () => {
      setArticleModal(false);
    }, children: /* @__PURE__ */ jsx(ArticleSearch, { onSave: onArticle }) }),
    /* @__PURE__ */ jsx("button", { className: "hidden", onClick: openModal, id: "editor-image-modal", children: "Add Image" }),
    /* @__PURE__ */ jsx("button", { className: "hidden", onClick: () => {
      setArticleModal(true);
    }, id: "editor-article-modal", children: "Article Embed" })
  ] });
};
function dropCapHandler() {
  ...
  const formats2 = editor.getFormat(lineStartIndex, 1);
  const isAlreadyDropCap = !!formats2["drop-cap"];
  if (line) {
...
function highlightHandler() {
  ...
  if (!range) return;
  const formats2 = editor.getFormat(range.index, range.length);
  editor.formatLine(range.index, range.length, "highlight", !formats2.highlight);
}
function customImageHandler() {
  var _a;
  quillRef = this.quill;
  (_a = document.querySelector("#editor-image-modal")) == null ? void 0 : _a.click();
}
function embedArticleHandler() {
  var _a;
  quillRef = this.quill;
  (_a = document.querySelector("#editor-article-modal")) == null ? void 0 : _a.click();
}
const formats = [
  "header",
  "bold",
...
const adRoots = /* @__PURE__ */ new Map();
const renderAdComponents = (editor) => {
  ...
  adNodes.forEach((node) => {
    ...
    if (adRoots.has(nodeKey)) return;
    const root = createRoot(node);
    root.render(/* @__PURE__ */ jsx(Advertisement, {}));
    adRoots.set(nodeKey, root);
  });
};
const QuillWysiwyg = ({ value, onChange }) => {
  const quillRef2 = useRef(null);
  const imageTooltipRef = useRef(null);
  const { setNotification } = useNotification();
  useEffect(() => {
    var _a;
    const editor = (_a = quillRef2.current) == null ? void 0 : _a.getEditor();
    if (!editor) return;
    const shortcodeHandler = (delta, oldDelta, source) => {
  ...
  useEffect(() => {
    ...
    const editor = (_a = quillRef2.current) == null ? void 0 : _a.getEditor();
    if (!editor) return;
    const imageHandler = (delta, _oldDelta, source) => {
      var _a2;
      (_a2 = delta.ops) == null ? void 0 : _a2.forEach((op) => {
        if (op.insert && op.insert.image && source == "api") {
  ...
  useEffect(() => {
    ...
    const handleDataTransfer = (e) => {
      ...
      if (!((_a2 = data == null ? void 0 : data.files) == null ? void 0 : _a2.length)) {
        return;
      }
      const hasImage = Array.from(data.files).some(
  ...
  useEffect(() => {
    ...
    const checkImageTooltip = (e) => {
      const img = e.target.closest('div[data-custom-image="true"]');
    ...
    editor == null ? void 0 : editor.root.addEventListener("click", checkImageTooltip);
    return () => {
      editor.root.removeEventListener("click", checkImageTooltip);
    };
  }, []);
  const changeHandler = (html, delta, source) => {
    var _a;
    const editor = (_a = quillRef2.current) == null ? void 0 : _a.getEditor();
    if (!editor) return;
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(CustomToolbar, {}),
    /* @__PURE__ */ jsx(
      ReactQuill,
      {
        id: "react-quill",
        ref: (el) => {
          quillRef2.current = el;
        },
        theme: "snow",
        defaultValue: value,
...
const InputWrapper = ({ label, children, tooltip }) => {
  return /* @__PURE__ */ jsxs("div", { className: "input-wrapper", children: [
    /* @__PURE__ */ jsxs("div", { className: "label-wrapper mb-4 flex gap-x-2 items-center", children: [
      /* @__PURE__ */ jsx("p", { className: "text-xl", children: label }),
...
const EditArticle = ({ action }) => {
  var _a, _b, _c, _d, _e, _f, _g, _h, _i;
  const [articleId, setArticleId] = useState(0);
  const [htmlContent, setHTMLContent] = useState(void 0);
  const [featuredImage, setFeaturedImage] = useState();
  const [featuredImage169, setFeaturedImage169] = useState();
  const [featuredImage43, setFeaturedImage43] = useState();
  ...
  const [isSlugManuallyInput, setIsSlugManuallyInput] = useState(false);
  ...
  useEffect(() => {
    var _a2, _b2;
    if (((_b2 = (_a2 = adminTaxonomies.countries) == null ? void 0 : _a2.find((coun) => coun.id == country)) == null ? void 0 : _b2.slug) == "indonesia" && !adminWarned) {
  ...
  useEffect(() => {
    var _a2, _b2;
    if (((_b2 = (_a2 = adminTaxonomies.countries) == null ? void 0 : _a2.find((coun) => coun.id == (userDetails == null ? void 0 : userDetails.id_country))) == null ? void 0 : _b2.slug) == "indonesia") {
      setNotification({ message: "Keep in mind, any indonesia's articles will be redirected to https://whatsnewindonesia.com", type: "fail" });
      setAdminWarned(true);
    }
  }, []);
  ...
  useEffect(() => {
    ...
    try {
      setAvailableCountries(((_a2 = adminTaxonomies.countries) == null ? void 0 : _a2.map((coun) => ({ value: coun.id, label: coun.name }))) ?? []);
    } catch (e) {
      console.log(e);
    }
  }, [adminTaxonomies]);
  useEffect(() => {
    ...
    (async () => {
      ...
      if (getArticle) {
        ...
        setFeaturedImage({ id: getArticle == null ? void 0 : getArticle.featured_image_id, url: getArticle == null ? void 0 : getArticle.featured_image_url });
        setFeaturedImage43({ id: getArticle == null ? void 0 : getArticle.featured_image_4_3_id, url: getArticle == null ? void 0 : getArticle.featured_image_4_3_url });
        setFeaturedImage169({ id: getArticle == null ? void 0 : getArticle.featured_image_16_9_id, url: getArticle == null ? void 0 : getArticle.featured_image_16_9_url });
        ...
        if (typeof (getArticle == null ? void 0 : getArticle.meta_data) == "string") {
          setMetaData(JSON.parse(getArticle.meta_data));
        } else {
          setMetaData((getArticle == null ? void 0 : getArticle.meta_data) ?? void 0);
        }
      }
    })();
  }, [articleId]);
  useEffect(() => {
    (async () => {
      ...
      if (country && !availableCities.length) {
        try {
          setAvailableCities(((_b2 = (_a2 = adminTaxonomies.cities) == null ? void 0 : _a2.filter((cit) => cit.id_parent == country)) == null ? void 0 : _b2.map((cit) => ({ value: cit.id, label: cit.name }))) ?? []);
        } catch (e) {
          console.log(e);
        }
      }
      if (city && !availableRegions.length) {
        try {
          setAvailableRegions(((_c2 = adminTaxonomies.regions) == null ? void 0 : _c2.filter((reg) => reg.id_parent == city).map((reg) => ({ value: reg.id, label: reg.name }))) ?? []);
        } catch (e) {
          console.log(e);
        }
      }
  ...
  useEffect(() => {
    if (taxonomies.categories && category) {
      ...
      if (getCategorySlug == null ? void 0 : getCategorySlug.id_parent) {
        const parentCat = taxonomies.categories.find((cat) => cat.id == getCategorySlug.id_parent);
        if (parentCat) {
          theMetaData = MetaDataMap[parentCat == null ? void 0 : parentCat.slug_title];
        }
      } else {
      ...
      if (theMetaData) {
        ...
        setSelectedMetaData(void 0);
      }
    }
  }, [category]);
  const renderMetadata = () => {
    if (!selectedMetaData) return;
    const valueChangeHandler = (value, keyReference) => {
      ...
      switch (type) {
        ...
        case METADATA_TYPE.DATE:
          ...
          return /* @__PURE__ */ jsx(
            ...
            {
              onChange: (e) => {
                valueChangeHandler(e == null ? void 0 : e.toISOString().split("T")[0], key);
              },
        ...
        case METADATA_TYPE.NUMBER:
          return /* @__PURE__ */ jsx(
            Input$1,
            {
              ...
              value: metaData ? metaData[key] ?? void 0 : void 0
            }
          );
        case METADATA_TYPE.MULTISELECT:
          return /* @__PURE__ */ jsx(
            ReactSelect,
            {
              ...
              options: ((_a2 = selectedMetaData[key]) == null ? void 0 : _a2.options) ? (_b2 = selectedMetaData[key]) == null ? void 0 : _b2.options.map((option) => ({ value: option, label: option })) : [],
              value: metaData ? (_c2 = metaData[key]) == null ? void 0 : _c2.map((w) => ({ value: w, label: w })) : void 0
            }
          );
        case METADATA_TYPE.ENUM:
          if ((_d2 = selectedMetaData[key].options) == null ? void 0 : _d2.length) {
            return /* @__PURE__ */ jsx(
              Select,
              {
                options: (_f2 = (_e2 = selectedMetaData[key]) == null ? void 0 : _e2.options) == null ? void 0 : _f2.map((option) => ({
                  value: option,
                  label: option
                })),
            ...
            return /* @__PURE__ */ jsx(Fragment, { children: "Something wrong with the select" });
          }
        ...
        case METADATA_TYPE.TRUE_FALSE:
          return /* @__PURE__ */ jsx(Switch, { label: key, defaultChecked: metaData ? Boolean(metaData[key]) : false, onChange: (e) => {
            valueChangeHandler(e, key);
          } });
        case METADATA_TYPE.TIME:
          const time = metaData ? new Date((/* @__PURE__ */ new Date()).setHours(Number(`${metaData[key]}`.split(":")[0]), Number(`${metaData[key]}`.split(":")[1]))) : null;
          return /* @__PURE__ */ jsx(
            TimePicker,
            {
              label: key,
              className: `time-input ${key}`,
              onChange: (e) => {
                const hour = e == null ? void 0 : e.getHours();
                const fixedHour = `${hour}`.length == 1 ? `0${hour}` : hour;
                const minute = e == null ? void 0 : e.getMinutes();
                const fixedMinute = `${minute}`.length == 1 ? `0${minute}` : minute;
                valueChangeHandler(`${fixedHour}:${fixedMinute}`, key);
              },
              value: time,
              disabled: checkWholeDay()
            }
          );
        default:
    ...
    if (selectedMetaData) {
      return Object.keys(selectedMetaData).map((key) => {
        var _a2, _b2;
        return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(InputWrapper, { label: `Metadata ${key}`, tooltip: (_a2 = selectedMetaData[key]) == null ? void 0 : _a2.tooltip, children: /* @__PURE__ */ jsx(Fragment, { children: renderInput((_b2 = selectedMetaData[key]) == null ? void 0 : _b2.type, key) }) }, `metadata-${key}`) });
      });
    }
    return /* @__PURE__ */ jsx(Fragment, {});
  };
  const renderCity = () => {
    if (availableCities.length && country) {
      return /* @__PURE__ */ jsx(InputWrapper, { label: "City", children: /* @__PURE__ */ jsx(Select, { options: availableCities, defaultValue: city ? `${city}` : void 0, placeholder: "Select City", onChange: cityChangeHandler }) });
    }
  };
  const renderRegion = () => {
    if (availableRegions.length && city) {
      return /* @__PURE__ */ jsx(InputWrapper, { label: "Region", children: /* @__PURE__ */ jsx(Select, { options: availableRegions, defaultValue: region ? `${region}` : void 0, placeholder: "Select Region", onChange: regionChangeHandler }) });
    }
  };
  const contentChangeHandler = (html, delta, source) => {
    setHTMLContent(html);
    if (source == "user") {
      setBlock(true);
    }
  ...
  const featuredImageHandler43 = (file) => {
    setFeaturedImage43({ url: `${API_URL}/${file.path}`, id: file.id });
    closeModal();
    setBlock(true);
  };
  const featuredImageHandler169 = (file) => {
  ...
  const metaTitleHandler = (e) => {
    setMetaData((oldMeta) => {
      return { ...oldMeta, meta_title: e.target.value };
    });
    setBlock(true);
  };
  const metaDescriptionHandler = (e) => {
    setMetaData((oldMeta) => {
      return { ...oldMeta, meta_description: e };
    });
    setBlock(true);
  };
  const saveArticleHandler = async (isPublish = false) => {
    if (isPublish) {
      setStatus("published");
    }
    const data = {
      article_post: htmlContent,
      featured_image: featuredImage == null ? void 0 : featuredImage.id,
      featured_image_id: featuredImage == null ? void 0 : featuredImage.id,
      featured_image_url: featuredImage == null ? void 0 : featuredImage.url,
      featured_image_4_3: featuredImage43 == null ? void 0 : featuredImage43.id,
      featured_image_4_3_id: featuredImage43 == null ? void 0 : featuredImage43.id,
      featured_image_4_3_url: featuredImage43 == null ? void 0 : featuredImage43.url,
      featured_image_16_9: featuredImage169 == null ? void 0 : featuredImage169.id,
      featured_image_16_9_id: featuredImage169 == null ? void 0 : featuredImage169.id,
      featured_image_16_9_url: featuredImage169 == null ? void 0 : featuredImage169.url,
      title,
      sub_title: subtitle,
  ...
  const renderTags = () => {
    ...
    return /* @__PURE__ */ jsx(InputWrapper, { label: "Tags", children: /* @__PURE__ */ jsx(ReactSelect, { options: availableTags.map((tag) => ({ label: tag.name, value: tag.id })), isMulti: true, onChange: tagsChangeHandler, value: availableTags.filter((tag) => tags.includes(tag.id)).map((tag) => ({ value: tag.id, label: tag.name })) }) });
  };
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-12 gap-x-12", children: [
    /* @__PURE__ */ jsxs("div", { className: "col-span-8", children: [
      /* @__PURE__ */ jsxs(ComponentCard, { children: [
        /* @__PURE__ */ jsx(InputWrapper, { label: "Title *", children: /* @__PURE__ */ jsx(Input$1, { required: true, placeholder: "Title", value: title, onChange: titleChangeHandler }) }),
        /* @__PURE__ */ jsx(InputWrapper, { label: "Slug *", children: /* @__PURE__ */ jsx(Input$1, { required: true, placeholder: "Slug", value: slug, onChange: slugChangeHandler }) }),
        /* @__PURE__ */ jsx(InputWrapper, { label: "Subtitle", children: /* @__PURE__ */ jsx(Input$1, { placeholder: "Subtitle", value: subtitle, onChange: subtitleChangeHandler }) }),
        /* @__PURE__ */ jsx(InputWrapper, { label: "Content *", children: /* @__PURE__ */ jsx(Fragment, { children: htmlContent !== void 0 && /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(QuillWysiwyg, { onChange: contentChangeHandler, value: htmlContent }) }) }) }),
        /* @__PURE__ */ jsx("div", { className: "spacer py-6" }),
        renderMetadata()
      ] }),
      /* @__PURE__ */ jsx("br", {}),
      /* @__PURE__ */ jsxs(ComponentCard, { children: [
        /* @__PURE__ */ jsx(InputWrapper, { label: "Meta Title", children: /* @__PURE__ */ jsx(Input$1, { placeholder: title, value: (metaData == null ? void 0 : metaData.meta_title) || "", onChange: metaTitleHandler }) }),
        /* @__PURE__ */ jsx(InputWrapper, { label: "Meta Description", children: /* @__PURE__ */ jsx(TextArea, { value: (metaData == null ? void 0 : metaData.meta_description) || "", placeholder: "Meta Description", onChange: metaDescriptionHandler }) })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "col-span-4", children: /* @__PURE__ */ jsxs(ComponentCard, { children: [
      /* @__PURE__ */ jsx(InputWrapper, { label: "Post Status", children: /* @__PURE__ */ jsx(Select, { value: status, options: [{ value: "published", label: "Publish" }, { value: "draft", label: "Draft" }, { value: "archived", label: "Archive" }, { value: "bin", label: "Bin" }], onChange: statusChangeHandler }) }),
      /* @__PURE__ */ jsx(InputWrapper, { label: "Featured Image 1:1", children: /* @__PURE__ */ jsx(AdminFeaturedImage, { url: (featuredImage == null ? void 0 : featuredImage.url) ? `${featuredImage == null ? void 0 : featuredImage.url}` : "#", onClick: openModal, onSave: featuredImageHandler }) }),
      /* @__PURE__ */ jsx(InputWrapper, { label: "Featured Image 16:9", children: /* @__PURE__ */ jsx(AdminFeaturedImage, { url: (featuredImage169 == null ? void 0 : featuredImage169.url) ? `${featuredImage169 == null ? void 0 : featuredImage169.url}` : "#", onClick: openModal, onSave: featuredImageHandler169 }) }),
      /* @__PURE__ */ jsx(InputWrapper, { label: "Featured Image 4:3", children: /* @__PURE__ */ jsx(AdminFeaturedImage, { url: (featuredImage43 == null ? void 0 : featuredImage43.url) ? `${featuredImage43 == null ? void 0 : featuredImage43.url}` : "#", onClick: openModal, onSave: featuredImageHandler43 }) }),
      /* @__PURE__ */ jsx(InputWrapper, { label: "Category *", children: /* @__PURE__ */ jsx(ReactSelect, { required: true, options: transformCategories(taxonomies.categories), placeholder: "Select Category", value: { value: category, label: (_b = (_a = taxonomies.categories) == null ? void 0 : _a.find((cat) => cat.id == category)) == null ? void 0 : _b.title, level: ((_d = (_c = taxonomies.categories) == null ? void 0 : _c.find((cat) => cat.id == category)) == null ? void 0 : _d.id_parent) ? 1 : 0 }, onChange: (newValue) => {
      ...
      /* @__PURE__ */ jsx(InputWrapper, { label: "Country *", children: /* @__PURE__ */ jsx(Select, { required: true, options: availableCountries, value: country ? (_e = availableCountries.find((coun) => coun.value == country)) == null ? void 0 : _e.value : void 0, placeholder: "Select Country", onChange: countryChangeHandler }) }),
      renderCity(),
      renderRegion(),
      renderTags(),
      /* @__PURE__ */ jsx(Switch, { checked: Boolean(pinned), onChange: (props) => {
        setPinned(props ? 1 : 0);
      }, label: "Pin Article" }),
      /* @__PURE__ */ jsxs("div", { className: "justify-end flex gap-x-8 ", children: [
        status !== "published" && /* @__PURE__ */ jsx(Button, { onClick: async () => {
          saveArticleHandler(true);
        }, children: "Go Publish" }),
        /* @__PURE__ */ jsx(Button, { onClick: async () => {
          saveArticleHandler();
        }, children: "Save" }),
        !!id && /* @__PURE__ */ jsx(Button, { children: /* @__PURE__ */ jsx(Link$1, { target: "_blank", to: `/${(_g = (_f = taxonomies == null ? void 0 : taxonomies.countries) == null ? void 0 : _f.find((tax) => tax.id == country)) == null ? void 0 : _g.slug}/${(_i = (_h = taxonomies.categories) == null ? void 0 : _h.find((cat) => cat.id == category)) == null ? void 0 : _i.slug_title}/${slug}`, children: "View Article" }) })
      ] })
    ] }) })
  ] }) });
};
