...
import { g as getTemplateByUrl } from "./template.service-DkLZb0NX.js";
import { Link, useNavigate, NavLink, Outlet } from "react-router";
import Skeleton from "react-loading-skeleton";
import { c as useHeaderContent, d as useRoute, b as useTaxonomies } from "./TimeContext-BnC1e41s.js";
...
const NavLocation = () => {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "country-select-wrapper flex md:gap-x-10 gap-y-4 md:items-center flex-col md:flex-row", children: [
    /* @__PURE__ */ jsx("div", { className: "title", children: /* @__PURE__ */ jsx("p", { className: "font-serif text-front-subtitle font-bold", children: "EXPLORE COUNTRIES" }) }),
    /* @__PURE__ */ jsx("div", { className: "item flex-1 grid grid-cols-4 gap-2 md:gap-4 w-full", children: (_c = filteredTax.countries) == null ? void 0 : _c.map((country) => {
      return /* @__PURE__ */ jsx("div", { className: "country col-span-2 md:col-span-1 uppercase text-center items-center", children: /* @__PURE__ */ jsx(Link, { className: "text-front-body border-[2px] border-front-red py-2 inline-block w-full transition text-white bg-front-red hover:text-black hover:bg-white", to: getCountryUrl(country), children: country.name }) }, `navlocation-explore-${country.id}`);
    }) })
  ] }) });
};
...
const SearchBar = ({ search, setSearch }) => {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "input-wrapper relative max-w-[320px] border border-[#eaeaea] w-full", onClick: clickHandler, children: [
    /* @__PURE__ */ jsx("form", { action: "#", onSubmit: submitHandler, ref: formRef, className: "overflow-hidden", children: /* @__PURE__ */ jsx("input", { type: "text", value: search, onChange: searchHandler, className: "p-4 w-full placeholder:text-[#b3b3b3]", placeholder: "Search for...", onBlur: blurHandler }) }),
