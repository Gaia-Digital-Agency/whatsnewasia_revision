...
import { g as getTemplateByUrl } from "./template.service-CbOuw4XG.js";
import { Link, useNavigate, NavLink, Outlet } from "react-router";
import Skeleton from "react-loading-skeleton";
import { c as useHeaderContent, d as useRoute, b as useTaxonomies } from "./TimeContext-CSdMZCoU.js";
...
const SvgSearch = (props) => /* @__PURE__ */ React.createElement("svg", { width: "1em", height: "1em", viewBox: "0 0 12 12", fill: "none", xmlns: "http://www.w3.org/2000/svg", ...props }, /* @__PURE__ */ React.createElement("path", { d: "M11.0999 11.1L8.46198 8.46207M0.899902 5.29655C0.899902 2.8684 2.86831 0.899994 5.29646 0.899994C7.72462 0.899994 9.69301 2.8684 9.69301 5.29655C9.69301 7.72471 7.72462 9.6931 5.29646 9.6931C2.86831 9.6931 0.899902 7.72471 0.899902 5.29655Z", stroke: "#a07b4f", strokeWidth: 1.2, strokeLinecap: "round", strokeLinejoin: "round" }));
...
const NavLogo = ({ to = "/" }) => {
  ...
  const renderImage = () => {
    ...
    if (!image && defaultImage) return /* @__PURE__ */ jsx("img", { src: defaultImage ? `${IMAGE_URL}/${defaultImage.url}` : "#", style: { display: defaultImage ? "block" : "none" }, width: 170, height: 76, alt: "Logo" });
    return /* @__PURE__ */ jsx("img", { src: image ? `${IMAGE_URL}/${image.url}` : "#", style: { display: image ? "block" : "none" }, width: 170, height: 76, alt: "Logo" });
  };
...
const NavLocation = () => {
  ...
  if (actualRoute.country) {
    return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row gap-y-2 md:gap-y-0 md:gap-x-3", children: [
      /* @__PURE__ */ jsx("div", { className: "md:w-[250px] w-full", children: /* @__PURE__ */ jsx(SelectNav, { classNames: { singleValue: "uppercase" }, defaultLabel: "All Asia", redOnActive: true, onChange: changeCountryHandler, value: (actualRoute == null ? void 0 : actualRoute.country) ? actualRoute.country.slug : void 0, options: ((_b = filteredTax == null ? void 0 : filteredTax.countries) == null ? void 0 : _b.map((country) => {
        return { value: country.slug, label: country.name };
      })) ?? [] }) }),
      !!(cities && actualRoute.country && cities.length) && /* @__PURE__ */ jsx("div", { className: "md:w-[250px] w-full", children: /* @__PURE__ */ jsx(SelectNav, { classNames: { singleValue: "uppercase" }, defaultLabel: "Explore City", onChange: changeCityHandler, value: actualRoute.city ? actualRoute.city.slug : void 0, options: cities.map((city) => {
        return { value: city.slug, label: city.name };
      }) }) }),
      !!(regions && actualRoute.city && regions.length) && /* @__PURE__ */ jsx("div", { className: "md:w-[250px] w-full", children: /* @__PURE__ */ jsx(SelectNav, { classNames: { singleValue: "uppercase" }, defaultLabel: "Explore by Area", onChange: changeRegionHandler, value: actualRoute.region ? actualRoute.region.slug : void 0, options: regions.map((region) => {
        return { value: region.slug, label: region.name };
      }) }) })
    ] }) });
  }
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "country-select-wrapper hidden lg:flex gap-x-[10px] gap-y-4 items-center w-full", children: [
...
const SearchBar = ({ search, setSearch }) => {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "input-wrapper relative max-w-[320px] border border-[#eaeaea] w-full", onClick: clickHandler, children: [
    /* @__PURE__ */ jsx("form", { action: "#", onSubmit: submitHandler, ref: formRef, className: "overflow-hidden", children: /* @__PURE__ */ jsx("input", { type: "text", suppressHydrationWarning: true, value: search, onChange: searchHandler, className: "p-4 w-full placeholder:text-[#b3b3b3]", placeholder: "Search for...", onBlur: blurHandler }) }),
    /* @__PURE__ */ jsx(SvgSearch, { className: "absolute right-4 top-1/2 -translate-y-1/2" })
  ] }) });
};
const DropDownCountry = () => {
  ...
  const changeHandler = (val) => {
    var _a2;
    const country = (_a2 = taxonomies == null ? void 0 : taxonomies.countries) == null ? void 0 : _a2.find((coun) => coun.slug == val);
    if (country) {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("div", { className: "dropdown-country-wrapper", children: /* @__PURE__ */ jsx(
    SelectNav,
    {
      onChange: changeHandler,
      options: ((_a = taxonomies.countries) == null ? void 0 : _a.filter((country) => country.slug != "asia").map((country) => ({ value: country.slug, label: country.name }))) || [],
      defaultLabel: "Choose Your Destination",
      value: ((_b = actualRoute.country) == null ? void 0 : _b.slug) || void 0,
      classNames: {
...
const DropDownCity = () => {
  ...
  const { taxonomies } = useTaxonomies();
  const navigate = useNavigate();
  const options = (_a = taxonomies.cities) == null ? void 0 : _a.filter((city) => {
    var _a2;
    return city.id_parent == ((_a2 = actualRoute == null ? void 0 : actualRoute.country) == null ? void 0 : _a2.id);
  }).map((city) => ({ value: city.slug, label: city.name }));
  const changeHandler = (val) => {
    var _a2, _b2;
    const city = (_a2 = taxonomies == null ? void 0 : taxonomies.cities) == null ? void 0 : _a2.find((coun) => coun.slug == val);
    if (city) {
      navigate(generateLocationRouteUrl({ ...actualRoute, city }));
      return;
    }
    navigate(`/${((_b2 = actualRoute.country) == null ? void 0 : _b2.slug) || ""}`);
    return;
  };
  if (actualRoute.country && (options == null ? void 0 : options.length)) {
    return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("div", { className: "dropdown-country-wrapper", children: /* @__PURE__ */ jsx(
      SelectNav,
      {
        onChange: changeHandler,
        ...
        value: ((_b = actualRoute.city) == null ? void 0 : _b.slug) || void 0,
        classNames: {
          singleValue: "dropdown-country-nav dropdown-country-input text-theme-front-red md:w-[260px] w-[190px]",
          option: "dropdown-country-nav dropdown-country-option text-theme-front-red"
        }
...
const DropDownRegion = () => {
  ...
  const { taxonomies } = useTaxonomies();
  const navigate = useNavigate();
  const options = (_a = taxonomies.regions) == null ? void 0 : _a.filter((city) => {
    var _a2;
    return city.id_parent == ((_a2 = actualRoute == null ? void 0 : actualRoute.city) == null ? void 0 : _a2.id);
  }).map((city) => ({ value: city.slug, label: city.name }));
  const changeHandler = (val) => {
    var _a2;
    const region = (_a2 = taxonomies == null ? void 0 : taxonomies.regions) == null ? void 0 : _a2.find((coun) => coun.slug == val);
    if (region) {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: actualRoute.country && actualRoute.city && options && /* @__PURE__ */ jsx("div", { className: "dropdown-country-wrapper", children: /* @__PURE__ */ jsx(
    SelectNav,
    {
      onChange: changeHandler,
      options: options || [],
      defaultLabel: "Choose Region",
      value: ((_b = actualRoute.region) == null ? void 0 : _b.slug) || void 0,
      classNames: {
        singleValue: "dropdown-country-nav dropdown-country-input text-theme-front-red md:w-[260px] w-[190px]",
        option: "dropdown-country-nav dropdown-country-option text-theme-front-red"
      }
...
const Header = () => {
    ...
    if (!headerMenus || headerMenus.length === 0) {
      (async () => {
        ...
        try {
          ...
          console.log("Error fetching header template:", e);
          const fallbackMenus = ((_d = (_c2 = taxonomies.categories) == null ? void 0 : _c2.filter((cat) => !cat.id_parent)) == null ? void 0 : _d.map((cat) => ({
            label: cat.title,
            url: cat.slug_title,
            linkCategory: cat.id
          }))) ?? [];
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("header", { className: "relative top-0 left-0 right-0 z-[100] bg-white", ref: headerRef, children: [
      /* @__PURE__ */ jsxs("div", { className: "container mx-auto py-6 flex justify-between items-center", children: [
        /* @__PURE__ */ jsxs("div", { className: "logo-wrapper w-max flex gap-x-0 md:gap-x-[20px] lg:gap-x-0 items-center", children: [
          /* @__PURE__ */ jsx(NavLogo, { url: "/logo-header", to: toNav() }),
          /* @__PURE__ */ jsx("div", { className: "dropdown-country hidden md:block lg:hidden", children: /* @__PURE__ */ jsx(DropDownCountry, {}) })
        ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "location-wrapper nav-location-wrapper", ref: locationRef, children: [
        /* @__PURE__ */ jsxs("div", { className: `inner container justify-between items-center mx-auto py-4 lg:flex flex ${actualRoute.country && ((_a = taxonomies.cities) == null ? void 0 : _a.filter((city) => {
          var _a2;
          return city.id_parent == ((_a2 = actualRoute.country) == null ? void 0 : _a2.id);
        }).length) ? "md:flex" : "md:hidden"}`, children: [
          /* @__PURE__ */ jsx("div", { className: "flex md:hidden", children: /* @__PURE__ */ jsx(DropDownCountry, {}) }),
          /* @__PURE__ */ jsxs("div", { className: "md:flex hidden lg:hidden gap-x-[20px]", children: [
            /* @__PURE__ */ jsx(DropDownCity, {}),
            /* @__PURE__ */ jsx(DropDownRegion, {})
          ] }),
          /* @__PURE__ */ jsx("div", { className: "item lg:flex hidden w-full", children: /* @__PURE__ */ jsx(NavLocation, {}) }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "inner container mx-auto py-4 nav-category-wrapper", children: [
          /* @__PURE__ */ jsx("div", { className: "menus-wrapper flex gap-x-4 md:gap-x-6", ref: categoryRef, children: (_c = (_b = taxonomies.categories) == null ? void 0 : _b.filter((cat) => {
            var _a2;
            return (_a2 = headerMenus == null ? void 0 : headerMenus.map((ca) => ca.linkCategory)) == null ? void 0 : _a2.includes(cat.id);
          })) == null ? void 0 : _c.map((menu) => /* @__PURE__ */ jsx(MenuNav, { menu, menus: headerMenus }, `header-menu-${menu.id}`)) }),
