...
import { l as login } from "./TimeContext-BxmeFsde.js";
...
function AuthLayout({
  ...
  return /* @__PURE__ */ jsx("div", { className: "relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0", children: /* @__PURE__ */ jsxs("div", { className: "relative flex flex-col justify-center w-full h-screen lg:flex-row dark:bg-gray-900 sm:p-0", children: [
    children,
    /* @__PURE__ */ jsx("div", { className: "items-center hidden w-full h-full lg:w-1/2 bg-[#F6041A] dark:bg-white/5 lg:grid", children: /* @__PURE__ */ jsxs("div", { className: "relative flex items-center justify-center z-1", children: [
