...
import { u as useAuth, b as useTaxonomies, g as getDataDetailUser, T as TimeProvider, a as TaxonomyProvider, R as RouteProvider, C as ContentProvider, H as HeaderContentProvider, A as AuthProvider, p as pkg } from "./assets/TimeContext-BxmeFsde.js";
...
const TemplateLayout = lazy(() => import("./assets/TemplateLayout-CEtkhgOj.js"));
const AppLayout = lazy(() => import("./assets/AppLayout-DKozA2a2.js"));
const Home = lazy(() => import("./assets/Home-da5OBunc.js"));
const SettingPage = lazy(() => import("./assets/SettingPage-BnQWriiS.js"));
const SocmedSettingPage = lazy(() => import("./assets/SocmedSettingPage-CYhTMT3-.js"));
const ConfigSMTP = lazy(() => import("./assets/ConfigSMTP-Si4lR6Ri.js"));
const MstCategories = lazy(() => import("./assets/MstCategories-DltXpmES.js"));
const MstTags = lazy(() => import("./assets/MstTags-F9u2IuYz.js"));
const MstLocations = lazy(() => import("./assets/MstLocations-BSqGFS0-.js"));
const MstTemplates = lazy(() => import("./assets/MstTemplates-CRXkaD7e.js"));
const GeneralTemplate = lazy(() => import("./assets/GeneralTemplate-D-LLt-TP.js"));
const AboutTemplate = lazy(() => import("./assets/AboutTemplate-Cgb6CKKE.js"));
const LocationTemplateExp = lazy(() => import("./assets/LocationTemplateExp-Cypc_ce7.js"));
const MstArticle = lazy(() => import("./assets/MstArticle-bcJsUGS_.js"));
const FormArticle = lazy(() => import("./assets/FormArticle-BWW9JSPI.js"));
const EditArticle = lazy(() => import("./assets/EditArticle-D6XLmQes.js"));
const Users = lazy(() => import("./assets/Users-BJh_k8Dm.js"));
const Registration = lazy(() => import("./assets/Registration-BaZajWeE.js"));
const UserProfiles = lazy(() => import("./assets/UserProfiles-Bgm1972v.js"));
const MediaForm = lazy(() => import("./assets/MediaForm-C6JHGPrn.js"));
const MediaLibrary = lazy(() => import("./assets/MediaLibrary-vpP2yPaq.js"));
const JobApplicant = lazy(() => import("./assets/JobApplicant-CRV0aGHC.js"));
const Subscribers = lazy(() => import("./assets/Subscribers-ClSgB2PP.js"));
